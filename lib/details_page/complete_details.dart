...
class completedetail extends StatefulWidget {
  ...
  completedetail(this.index,this.comAddress,this.comdelivery,this.comgarment,this.comorderidd,this.comrs,this.comtime,this.time2);
        ...
        children: [
          Card(
            child: Container( alignment: Alignment.centerLeft,
              ...
              child: Text("ORDER ID : ${widget.comorderidd[widget.index]}",
            ...
            child: Container(
              ...
              child: Column( crossAxisAlignment: CrossAxisAlignment.end,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      SizedBox(width: twidth*0.25,),
                      Expanded(
                        child: Text("${widget.comAddress[widget.index]}",
                  ...
                  Container(
                    child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Text("${widget.comtime[widget.index]}",
                            style: GoogleFonts.montserrat(
                              fontSize: 12,
              ...
              child: Column( crossAxisAlignment: CrossAxisAlignment.end,
                ...
                children: [
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.end,
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Service type(${widget.comdelivery[widget.index]})",
                          style: GoogleFonts.montserrat(
                            fontSize: 12,
                            fontWeight: FontWeight.w300,
                          )),
